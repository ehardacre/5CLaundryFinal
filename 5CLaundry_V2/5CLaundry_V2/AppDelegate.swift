...
//  AppDelegate.swift
//  5CLaundry
///Users/ethanhardacre/Desktop/5CLaundry/5CLaundryFinal/5CLaundry/Preferences.xcdatamodeld
...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, MessagingDelegate{
    ...
    var registrationToken : String? = Messaging.messaging().fcmToken
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        registrationToken = Messaging.messaging().fcmToken
    ...
    // The callback to handle data from FCM for devices running iOS 10+.
